...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright LukeZeitlin, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/CombOver2-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/CombOver2-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/CombOver2-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/CombOver2-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/CombOver2-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/CombOver2-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/CombOver2-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/CombOver2.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/CombOver2.iss",inplace=1):
